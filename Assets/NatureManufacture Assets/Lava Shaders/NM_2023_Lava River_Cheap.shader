Shader "NatureManufacture/Lava River/Lava River Cheap"
{
	Properties
	{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_302_0 = ( lerpResult310 * clampResult326 );
			...
			#ifdef _Dynamic_Flow
				float3 staticSwitch237 = ( ( appendResult131_g18 * clampResult325 ) + temp_output_302_0 );
			#else
