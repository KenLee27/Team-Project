...
public class BowEnemyController : MonoBehaviour, Ienemy
{
    ...
    public void PlayRandomChargeSound()
    {
        ...
        {
            Debug.LogWarning("No charge sounds assigned!");
            return;
        }

        int randomIndex = UnityEngine.Random.RandomRange(0, chargeSound.Length);
        AudioClip selectedClip = chargeSound[randomIndex];
        audioSource.PlayOneShot(selectedClip);
    }

    public void PlayRandomShotSound()
    {
        if (shotSound.Length == 0)
        {
            Debug.LogWarning("No shot sounds assigned!");
            return;
        }

        int randomIndex = UnityEngine.Random.RandomRange(0, shotSound.Length);
        AudioClip selectedClip = shotSound[randomIndex];
        audioSource.PlayOneShot(selectedClip);
    }
    public void PlayRandomFootSound()
    {
        if (footSound.Length == 0)
        {
            Debug.LogWarning("No foot sounds assigned!");
            return;
        }
    ...
    public void PlayRandomAttackSound()
    {
        ...
        {
            Debug.LogWarning("No attack sounds assigned!");
            return;
        }
    ...
    public void PlayRandomAttackedSound()
    {
        ...
        {
            Debug.LogWarning("No attacked sounds assigned!");
            return;
        }
