...
public class EnemyEliteController : MonoBehaviour, Ienemy
{
    ...
    public void PRSParing()
    {
        int randomIndex = UnityEngine.Random.RandomRange(0, paringSound.Length);
        AudioClip selectedClip = paringSound[randomIndex];
        audioSource.PlayOneShot(selectedClip);
    }

    public void PRSShieldBreak()
    {
        int randomIndex = UnityEngine.Random.RandomRange(0, shieldBreakSound.Length);
        AudioClip selectedClip = shieldBreakSound[randomIndex];
        audioSource.PlayOneShot(selectedClip);
    }
